...
Page({
  ...
  data: {
    ...
    ui_config:{
      ...
      ui_symbol_name:"系列名称",
      ui_hello:"您好,",
      ui_greeting:"您的账户已经过期或未登录，如果你想继续普洱茶行情速报网，请先点击左上角的立即登录按钮或联系客服人员（微信号：jujilongtou888）",
    },
    wxapp_settings:{
      config_appkey : '', 
      config_appsecret : '', 
      settings_url : 'https://api.limc.cn/api/ui/settings_juji_999_qiye.json',
      data_api_url : 'https://api.limc.cn/stage/api/SignalConfirm',
      data_api_param_count : '10',
      data_api_param_ttl : '0', 
      data_api_params:null,
      user_info_url: 'https://api.limc.cn/api/User',
  ...
  requestData: function () {
    ...
    if(_this.data.wxapp_settings.data_api_params != null){
      Object.entries(_this.data.wxapp_settings.data_api_params).forEach(([key,val]) => {
        url = url + '&'+key + '=' + val
      })
    }  
  ...
  requestUserData: function (res) {
    ...
    wx.request({
      ...
      data: {
        ...
        oid: app.globalData.userOpenId.openid
      },
      method: "POST",
      header: {
        'content-type': 'application/json' // 默认值
