...
Page({
  ...
  data: {
    ...
    ui_config:{
      ...
      ui_symbol_name:"系列名称",
      ui_hello:"您好,",
      ui_greeting:"您的账户已经过期或未登录，如果你想继续龙猫量化，请先点击左上角的立即登录按钮或联系客服人员（微信号：longmaolianghua）",
    },
    wxapp_settings:{
      config_appkey : '', 
      config_appsecret : '', 
      settings_url : 'https://api.limc.cn/api/ui/settings_longmao_888.json',
      data_api_url : 'https://api.limc.cn/stage/api/Signal',
      data_api_param_count : '5',
      data_api_param_ttl : '0', 
      data_api_params:null,
      user_info_url: 'https://api.limc.cn/wxapi/WxUser',
      user_sub_url : 'https://api.limc.cn/wxapi/Subscribe',
    },
  },
