...
namespace KaiPanLa
{
    public partial class FrmSignalQuant : Form
    {
        ...
        {
            this.Location = new Point(size.Width / 2 - 10, size.Height / 2 - 100);
        ...
        {
            FrmSignalFilterCond frmSignalFilter = new FrmSignalFilterCond();
        ...
        {
            //先清空
            DataTableToEntity<StockSignalAnalyseListItemEntity> util = new DataTableToEntity<StockSignalAnalyseListItemEntity>();
            List<StockSignalAnalyseListItemEntity> listClear = new List<StockSignalAnalyseListItemEntity>();
            DataTable dtClear = util.FillDataTable(listClear);
            ...
            List<StockSignalAnalyseListItemEntity> list = new List<StockSignalAnalyseListItemEntity>();
            int index = 0;
            foreach (var row in query)
            {
                var newEntity = new StockSignalAnalyseListItemEntity
                {
                    _Number = ++index,
        ...
        private DataTable QueryDatatableFromDatabase()
        {
            ...
            {
                String tableName = Common.GetAppSettingByKey("StockSignalConfirmTableName");
