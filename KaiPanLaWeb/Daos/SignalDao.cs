...
namespace KaiPanLaWeb.Daos
{
    public class SignalDao
    {
        ...
        public List<SignalDetail> QuerySignalDetails(DateTime date, Int64 ttl, Int64 count, Int64 delay)
        {
            DataTable dtInDb = QueryDetailDataTableFromDB(date, ttl, count, delay);
        ...
        public List<Signal> QuerySignals(DateTime date, Int64 ttl, Int64 count, Int64 delay)
        {
            DataTable dtInDb = QueryDataTableFromDB(date, ttl, count, delay);
        ...
        private DataTable QueryDataTableFromDB(DateTime date, Int64 ttl, Int64 count, Int64 delay)
        {
            ...
            using (SqlConnection destinationConnection = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    String xhgxsj_to = "235959";
                    if (delay > 0)
                    {
                        xhgxsj_to = DateTime.Now.AddSeconds(-delay).ToString("HHmmss");
                    }
                    cmdSelect.Parameters.Add(new SqlParameter("@XHGXSJ_TO", xhgxsj_to));
        ...
        private DataTable QueryDetailDataTableFromDB(DateTime date, Int64 ttl, Int64 count, Int64 delay)
        {
            string connectionString = Common.GetDatabaseConnectString();
